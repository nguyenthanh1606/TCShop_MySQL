using TCShop.Application.Common;
using TCShop.Data.EF;
using TCShop.Data.Entities;
using TCShop.Utilities.Exceptions;
...
namespace TCShop.Application.Catalog.Products
{
    ...
    {
        private readonly TCShopDbContext _context;
        private readonly IStorageService _storageService;

        public ManageProductService(TCShopDbContext context, IStorageService storageService)
        {
            _context = context;
            _storageService = storageService;
        }

        #region ---Interface Product Service---
        #region CURD Product
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null) throw new TCShopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new TCShopException($"Cannot find a product with id: {productId}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new TCShopException($"Cannot find a product: {productId}");
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            if (productImage == null)
                throw new TCShopException($"Cannot find an image with id {imageId}");
        ...
        #endregion
        #endregion Interface Product Service
