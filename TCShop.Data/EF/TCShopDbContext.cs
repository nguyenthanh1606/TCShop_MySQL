...
using System;
using TCShop.Data.Configurations;
using TCShop.Data.Entities;
using TCShop.Data.Extensions;

namespace TCShop.Data.EF
{
    public class TCShopDbContext : IdentityDbContext<AppUser,AppRole,Guid>
    {
        public TCShopDbContext(DbContextOptions options) : base(options)
        {
        }
